...
CREATE TABLE IF NOT EXISTS public.hr_agreements (
    ...
    scope_of_work TEXT DEFAULT '[]', -- JSON string
    rates_of_work TEXT DEFAULT '[]', -- JSON string
    payment_schedule TEXT DEFAULT '[]', -- JSON string
    company_id TEXT NOT NULL,
    created_at TIMESTAMP WITH TIME ZONE DEFAULT NOW()
);

-- If you already have the table, run these ALTER commands to ensure synchronization:
